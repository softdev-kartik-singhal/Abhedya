...
async function main() {
    ...
    console.log("Session handshakes...");
    ...
    rowIds.CrimeSubHead = await insertOrGetRowId("CrimeSubHead", { CrimeSubHeadID: 1, CrimeHeadName: "Theft", Active: true });

    console.log("\nMaster ROWIDs mapping:");
    ...
    console.log("Saved rowid_mapping.json successfully.");
}
