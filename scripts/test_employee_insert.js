...
async function main() {
    ...
    const employeePayload = [{
        ...
        FirstName: "Medhavi",
        DistrictID: String(rowIds.District),
        UnitID: String(rowIds.Unit),
        RankID: String(rowIds.Rank),
        DesignationID: String(rowIds.Designation),
        EmployeeDOB: "1995-05-15",
        GenderlD: 2,
        BloodGroupID: 1,
    ...
    const payloadStr = JSON.stringify(employeePayload);

    console.log("Inserting Employee Medhavi into Zoho Catalyst Datastore online...");
    ...
    console.log("Employee Insert Status:", res.status);
    console.log("Employee Insert Response:", res.body);
}
