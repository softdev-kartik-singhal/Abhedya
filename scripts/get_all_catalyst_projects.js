...
async function main() {
    ...
    console.log("--- Projects in Org 60077759371 ---");
    const prjList = await makeApiRequest({ hostname: "api.catalyst.zoho.in", port: 443, path: "/baas/v1/projects", method: "GET", headers: baseHeaders });
    console.log(prjList.body);
}
