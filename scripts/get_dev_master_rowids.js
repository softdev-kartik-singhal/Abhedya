...
async function main() {
    ...
    const tables = [
        "District", "Unit", "Employee", "CaseCategory", "GravityOffence",
        "CaseStatusMaster", "Court", "CrimeHead", "CrimeSubHead"
    ];
    ...
    console.log("Development Environment Master ROWIDs:");
    console.log(JSON.stringify(mapping, null, 2));

    fs.writeFileSync(path.join(__dirname, 'rowid_mapping_dev.json'), JSON.stringify(mapping, null, 2));
}
